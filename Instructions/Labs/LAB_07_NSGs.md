...
1. **가상 네트워크 만들기** 블레이드의 **기본** 탭에서 다음 설정을 지정하고(다른 설정은 기본값 그대로 둡니다) **다음: IP 주소**를 클릭합니다.

    |설정|값|
    |---|---|
    |구독|이 랩에서 사용 중인 Azure 구독의 이름|
    |리소스 그룹| **새로 만들기**를 클릭하고 이름 **AZ500LAB07**을 입력합니다.|
    |이름| **myVirtualNetwork** |
    |지역| **미국 동부** |
...
1. **다음:** 클릭 **디스크 >** 를 클릭하고 **가상 머신 만들기** 블레이드의 **디스크** 탭에서 **OS 디스크 유형**을 **표준 HDD**로 설정하고 **다음:** 을 클릭합니다. **네트워킹 >**.

1. **가상 머신 만들기** 블레이드의 **네트워킹** 탭에서 **가상 네트워크** 텍스트 상자 아래의 **새로 만들기**를 클릭합니다.
...
1. Azure Portal에서 **가상 머신** 블레이드로 돌아가 **+ 추가**를 클릭합니다.
...
1. **다음:** 을 클릭합니다. **디스크 >** 를 클릭하고 **가상 머신 만들기** 블레이드의 **디스크** 탭에서 **OS 디스크 유형**을 **표준 HDD**로 설정하고 **다음:** 을 클릭합니다. **네트워킹 >**.
...
1. **가상 네트워크 만들기** 블레이드에서 다음 설정을 지정합니다(다른 설정은 기본값으로 남겨둡니다).
   ...
   |서브넷 이름| **기본값** |
   |서브넷 범위| **10.0.0.0/24** |
   |공용 IP| **(new)myVMMgmt-ip** |
   |NIC 네트워크 보안 그룹| **고급** |
   |네트워크 보안 그룹 구성| **myNsg** |

1. **다음:** 을 클릭합니다 **관리 >** 를 클릭하고 **가상 머신 만들기** 블레이드의 **관리** 탭에서 다음 설정을 지정합니다.
...
1. **myVMWeb** 블레이드의 **설정** 섹션에서 **네트워킹**을 클릭한 다음 **myVMWeb**에서 **\| 네트워킹** 블레이드에서 **애플리케이션 보안 그룹** 탭을 클릭합니다.
...
1. **myVMMgmt** 블레이드의 **설정** 섹션에서 **네트워킹**을 클릭한 다음 **myVMMgmt**에서 **\| 네트워킹** 블레이드에서 **애플리케이션 보안 그룹** 탭을 클릭합니다.
